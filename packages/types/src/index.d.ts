...
export type BookingStatus = 'PENDING_PAYMENT' | 'PAYMENT_AUTHORIZED' | 'CONFIRMED' | 'PROVIDER_EN_ROUTE' | 'IN_PROGRESS' | 'COMPLETED' | 'CANCELLED_CLIENT' | 'CANCELLED_PROVIDER' | 'CANCELLED_SYSTEM' | 'DISPUTED' | 'REFUNDED';
...
export type AnalyticsEventName = 'search.performed' | 'search.provider_viewed' | 'search.provider_clicked' | 'booking.initiated' | 'booking.created' | 'booking.provider_accepted' | 'booking.provider_rejected' | 'booking.completed' | 'booking.cancelled_provider' | 'review.submitted' | 'recurrence.created' | 'provider.location_updated';
